...
SECRET_KEY = 'django-insecure-mtv0luw_bf2*yb4k5@)acp)9!$%+12gprf&c)^@hi4-&7ba7cf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS").split(" ")
# ALLOWED_HOSTS = ['localhost', '0.0.0.0:8000', '0.0.0.0', '[::1]']
ALLOWED_HOSTS = ['*']
...
AUTH_USER_MODEL = 'rest_trello.CustomUser'
